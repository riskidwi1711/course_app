...
export default function WebContent({ auth , pageIdentity}) {
    return (
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        >
                            <div class="account_setting">
                                ...
                                <p>
                                    This is your public presence on Cursus. You
                                    need a account to upload your paid courses,
                                    comment on courses, purchased by students,
                                    or earning.
                                </p>
                        ...
                        >
                            <div class="account_setting">
                                ...
                                <p>
                                    Select push and email notifications you'd
                                    like to receive
                                </p>
                                <div class="basic_profile">
                                    <div class="basic_form">
                                        <div class="nstting_content">
                                            ...
                                            <div class="ui toggle checkbox _1457s2">
                                                ...
                                                <p class="ml5">
                                                    Notify me of courses I might
                                                    like based on what I watch
                                                </p>
                                            </div>
                                            <div class="ui toggle checkbox _1457s2">
                                                <input
                                    ...
                                    <div class="basic_form">
                                        <div class="nstting_content">
                                            ...
                                            <div class="ui toggle checkbox _1457s2">
                                                ...
                                                />
                                                <label>
                                                    Send me emails about my
                                                    Cursus activity and updates
                                                    I requested
                                                </label>
                                                <p class="ml5">
                                                    If this setting is turned
                                                    off, Cursus may still send
                                                    you messages regarding your
                                            ...
                                            <div class="ui toggle checkbox _1457s2">
                                                ...
                                                <label>
                                                    Announcements from
                                                    instructors whose course(s)
                                                    I’m enrolled in.
                                                </label>
                                                <p class="ml5">
                                                    To adjust this preference by
                                                    course, leave this box
                                                    checked and go to the course
                                                    dashboard and click on
                                                    "Options" to opt in or out
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="basic_ptitle">
                                                ...
                                                <p>
                                                    Sell more of your exclusive
                                                    products of this type (equal
                                                    to the amount on the left)
                                                    to get % cut from further
                                                    exclusive sales.
                                                </p>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="basic_ptitle">
                                                ...
                                                <p>
                                                    Sell more of your
                                                    non-exclusive products of
                                                    this type (equal to the
                                                    amount on the left) to get
                                                    70% cut from every
                                                    non-exclusive sales.
                                                </p>
                                            </div>
                        ...
                        >
                            <div class="account_setting">
                                <h4>Affiliate API</h4>
                                <p>
                                    The Cursus Affiliate API exposes
                                    functionalities of Cursus to help developers
                                    build client applications and integrations
                                    with Cursus. <br />
                                    To see more details, please visit{" "}
                                    <a href="#">Cursus Affiliate API</a>
                                </p>
                            </div>
                            <button class="api_btn">
                                Request Affiliate API Client
                            </button>
                            <div class="nt_apt">
                                <i class="uil uil-info-circle"></i> You don't
                                have any API clients yet.
                            </div>
                        </div>
                        <div
                            class="tab-pane fade"
                        ...
                        >
                            <div class="account_setting">
                                <h4>Close account</h4>
                                <p>
                                    <strong>Warning:</strong> If you close your
                                    account, you will be unsubscribed from all
                                    your 5 courses, and will lose access
                                    forever.
                                </p>
                            </div>
                            <div class="row">
