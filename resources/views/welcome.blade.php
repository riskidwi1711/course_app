...
<head>
    ...
    <title>Bimbel NIPASN</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="shortcut icon" type="image/x-icon" href="assets/landing_page/img/logo/logo_NIPASN.jpeg">
...
<body class="body__wrapper">
    ...
    <div id="back__preloader">
        ...
        <div class="back__loader_logo">
            <img src="assets/landing_page/img/logo/logo_NIPASN.jpeg" alt="Preload">
        </div>
    </div>
    </div>
    <!-- pre loader area end -->
    ...
    <main class="main_wrapper overflow-hidden">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="topbar__left">
                            <ul>
                                <li>
                                    Telepon Kami: 0852-1075-7830 (Rahmad Dhani Eritwan)
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="topbar__right">
                            ...
                            <div class="topbar__text">
                                <p>Bimbel CPNS | PPPK Full Online</p>
                            </div>
                            <div class="topbar__list">
                                <ul>
                                    <li>
                                        <a href="https://www.tiktok.com/@nipasnbimbel?_t=8eMTjA8sbfl&_r=1" target="_blank" rel="noopener noreferrer">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#ffffff}</style><path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"/></svg>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://t.me/Infoasn2023" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <li>
                                        <a href="https://www.instagram.com/bimbelnipasn.id/" target="_blank" rel="noopener noreferrer"><i class="icofont-instagram"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            <div class="headerarea__left">
                                <div class="headerarea__left__logo">
                                    ...
                                    <a href="index.html"><img src="assets/landing_page/img/logo/logo_NIPASN.jpeg" style="width: 100px" alt="logo"></a>
                                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-6">
                            <div class="mobile-logo">
                                <a href="index.html"><img src="assets/landing_page/img/logo/logo_NIPASN.jpeg" style="width: 125px" alt="logo"></a>
                            </div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="herobannerarea__content__wraper">
                            ...
                            <div class="herobannerarea__title">
                                <div class="herobannerarea__small__title">
                                    <span>SAHABAT NIPASN</span>
                                </div>
                                <div class="herobannerarea__title__heading__2 herobannerarea__title__heading__3">
                                    <h2>Perjalanan Kamu Menjadi ASN Dimulai dari Sini!</h2>
                                </div>
                            </div>


                            <div class="herobannerarea__text herobannerarea__text__2">
                                <p>Belajar setiap hari belum tentu dapat menguasai materi. Coba terapkan konsep belajar Learn, Do & Teach bersama kami!</p>
                            </div>
                            <div class="hreobannerarea__button__2">
                                <a class="default__button hreobannerarea__button__3" href="/login">Coba Try Out Gratis</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="aboutarea__img__2" data-tilt>
                            <img class="aboutimg__1" src="assets/landing_page/img/about/pns_image_2.png" alt="aboutimg">
                        </div>
                ...
                <div class="row">
                    <div class="section__title text-center" data-aos="fade-up">
                        <div class="section__title__button">
                            <div class="default__small__button">Introduced</div>
                        </div>
                        <div class="section__title__heading heading__underline">
                            <h2>Sahabat <span>NIPASN</span>.</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-12" data-aos="fade-up">
                        <ul class="nav  about__button__wrap justify-content-center" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="single__tab__link active" data-bs-toggle="tab" data-bs-target="#projects__one" type="button">Tentang Kami</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="single__tab__link" data-bs-toggle="tab" data-bs-target="#projects__two" type="button">Visi Misi</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="single__tab__link" data-bs-toggle="tab" data-bs-target="#projects__three" type="button">Layanan Kami</button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content tab__content__wrapper" id="myTabContent" data-aos="fade-up">
                        ...
                        <div class="tab-pane fade active show" id="projects__one" role="tabpanel" aria-labelledby="projects__one">
                            <div class="col-xl-12">
                                <div class="aboutarea__content__tap__wraper">
                                    <p class="paragraph__1">NIPASN adalah perseroan terbatas yang bergerak di bidang pendidikan nonformal yang berfokus pada bimbingan belajar dan konseling swasta didirikan berdasarkan hukum yang berlaku di Indonesia.
                                        <br><br>
                                        Telah mendapatkan pengesahan pendirian badan Hukum dari Kementerian Hukum dan Hak Asasi Manusia Republik Indonesia.
                                        <br><br>
                                        NIPASN merupakan salah satu flatform bimbingan belajar CPNS yang telah dipercaya lebih dari 27.000 member. Kami telah memiliki lebih dari 5 program pilihan baik itu SKD CPNS, SKD Kedinasan, SKB, Ujian Kompetensi, PPPK dan BUMN serta UTBK yang semuanya berbasis CAT (Computer Assisted Test).</p>
                                        <img src="img/about/overview_kg.png" alt="">
                                </div>
                        ...
                        <div class="tab-pane fade" id="projects__two" role="tabpanel" aria-labelledby="projects__two">
                            ...
                            <div class="col-xl-12">
                                <div class="aboutarea__content__tap__wraper">
                                    <p class="paragraph__1">Membantu mensukseskan para member dalam ujian dengan menyediakan soal-soal, materi yang berkualitas, video pembelajaran, biaya terjangkau dan dapat diakses dimanapun, kapanpun serta menjadi wadah dalam kegiatan berbagi sesama pejuang keluarga.</p>
                                </div>
                                ...
                                <div class="aboutarea__content__tap__wraper">
                                    <div class="aboutarea__list__2">
                                        <div class="row">
                                            ...
                                            <ul>
                                                <li>
                                                    <i class="icofont-check"></i> Program Bimbel SKD CPNS
                                                </li>
            
                                                <li>
                                                    <i class="icofont-check"></i> Program Bimbel SKD kedinasan
                                                </li>
            
                                                <li>
                                                    <i class="icofont-check"></i> Program Bimbel SKB CPNS
                                                </li>
                                                
                                                <li>
                                                    <i class="icofont-check"></i> Program Bimbel PPPK
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-6">
                                            <ul>
                                                <li>
                                                    <i class="icofont-check"></i> Program Bimbel TKD BUMN
                                                </li>
            
                                                <li>
                                                    <i class="icofont-check"></i> Program Bimbel PPG
                                                </li>
            
                                                <li>
                                                    <i class="icofont-check"></i> Program Bimbel UTBK
                                                </li>
                                                
                                                <li>
                                                    <i class="icofont-check"></i> Program Bimbel Ukom
                                                </li>
                                            </ul>
                                            </div>
                                        </div>
                ...
                <div class="row populerarea__wraper">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="populerarea__heading heading__underline">
                            <div class="default__small__button">Member Facility</div>
                            <h2 style="text-align: center">Fasilitas <span>Member</span></h2>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="course-details.html">Materi Terupdate</a></h3>
                                <p>Materi terbaru yang selalu diupdate untuk memudahkan kamu belajar dan lulus tes.</p>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="#">Latihan Soal</a></h3>
                                <p>Latihan soal per sub materi agar para peserta bisa melihat kemampuan per materi yang akan diujikan</p>
                            </div>
                            <div class="service__small__img">
                                <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="#">Try Out sistem CAT</a></h3>
                                <p>Sistem Try out untuk evaluasi kemampuan hasil belajar.</p>
                            </div>
                            <div class="service__small__img">
                                <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="#">Statistik Nilai</a></h3>
                                <p>Statistik nilai dari hasil latihan dan try out.</p>
                            </div>
                            <div class="service__small__img">
                                <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="col-xl-5 col-lg-5" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="#">Group diskusi</a></h3>
                                <p>Group diskusi yang sediakan untuk tanya jawab seputar soal dan info terupdate.</p>
                            </div>
                            <div class="service__small__img">
                                <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="course-details.html">Webinar Gratis</a></h3>
                                <p>Webinar pelatihan.</p>
                            </div>
                            <div class="service__small__img">
                                <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="course-details.html">Ranking Nasional</a></h3>
                                <p>Rangking dari semua peserta tes di website, ayo jadi yang terbaik.</p>
                            </div>
                            <div class="service__small__img">
                                <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
        ...
        <div class="gridarea gridarea__2">
            <div class="container">
                <div class="row grid__row">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12" data-aos="fade-up">
                        <div class="section__title__2">
                            <div class="section__title__button">
                                <div class="default__small__button">New Fiturs</div>
                            </div>
                ...
                <div class="row grid" data-aos="fade-up">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter1 filter3">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.html"><img style="width: 100%; height: 150px;" src="https://www.jagoanhosting.com/blog/wp-content/uploads/2017/08/Peluang-Kerja-Dibidang-Data-Analyst-e1643819064125-1200x720.jpg" alt="grid"></a>
                            </div>
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__heading">
                                    <h3 style="font-size: 17px">
                                        ...
                                        Analisa waktu pengerjaan soal</a>
                                    </h3>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter1 filter3">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="#"><img style="width: 100%; height: 150px;" src="https://akupintar.id/documents/portlet_file_entry/20143/pengertian+video+pembelajaran.jpg/30a34a2e-f878-6112-c754-56388b0d8dad?imagePreview=1" alt="grid"></a>
                            </div>
                            <div class="gridarea__content">
                                <div class="gridarea__heading">
                                    <h3><a href="#">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter1 filter3">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.html"><img style="width: 100%; height: 150px;" src="https://www.groovypost.com/wp-content/uploads/2021/07/rear-view-of-asian-business-woman-say-hello-with-teamwork-colleague-picture-id1241178021.jpg" alt="grid"></a>
                            </div>
                            <div class="gridarea__content">
                                {{-- <div class="gridarea__list">
                                    <ul>
        ...
        <div class="aboutarea__2 aboutarea__4 sp_bottom_30" style="margin-top: 50px;">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="about__right__wraper__2 about__right__wraper__4">
                            <div class="educationarea__img" data-tilt>
                                ...
                                <img class="aboutimg__4__img__2" src="assets/landing_page/img/about/pns_image_1.png" alt="about">
                            </div>
                        ...
                        <div class="aboutarea__content__wraper">
                            ...
                            <div class="section__title__2">
                                <div class="section__small__title">
                                    <span>Join with NIPASN</span>
                                </div>
                                <div class="section__title__heading__2 section__title__heading__3 heading__fontsize__2">
                                    <h2>Mengapa harus join bersama NIPASN ?</h2>
                                </div>
                            </div>


                            <div class="aboutarea__para aboutarea__para__2">
                                <p>Berjuang bersama ASN</p>
                            </div>
                            <div class="aboutarea__list__2">
                                    <ul>
                                        <li>
                                            <i class="icofont-check"></i> Lembaga Bimbingan belajar resmi & mentor ASN berkualitas
                                        </li>
    
                                        <li>
                                            <i class="icofont-check"></i> Sudah berpengalaman bersama lebih 100.000 member
                                        </li>
    
                                        <li>
                                            <i class="icofont-check"></i> Program bimbingan yang terbukti meloloskan ribuan member
                                        </li>
                                        
                                        <li>
                                            <i class="icofont-check"></i> Aplikasi Website selalu di update
                                        </li>

                                        <li>
                                            <i class="icofont-check"></i> Friendly User
                                        </li>
    
                                        <li>
                                            <i class="icofont-check"></i> Biaya terjangkau
                                        </li>
                                    </ul>
        ...
        <div class="aboutarea__3 testimonial__area__2 sp_bottom_90 sp_top_120">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 custom__review__grid" data-aos="fade-up">
                        <div class="section__title aboutarea__3__section__title">
                            <div class="section__title__button">
                                <div class="default__small__button">Interview</div>
                            </div>
                            <div class="section__title__heading">
                                <h2>Apa kata
                                    <br>Sahabat NIPASN</h2>
                            </div>
                        </div>

                        <div class="aboutarea__3__content">
                            <p>Cerita mereka bersama NIPASN selama pembelajaran hingga tujuan tercapai dengan berhasil dan lancar.</p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 custom__review__grid" data-aos="fade-up">
                        <div class="aboutarea__content__wraper__3">
                            <div class="aboutarea__para__3">
                                <p>“Saya belajar di NIPASN 2 minggu sebelum tes cpns 2019, Alhamdulillah skd dan skb peringkat pertama. Saat ini saya PNS di Pemkab Cianjur. Belajar di ayo cpns sangat menyenangkan dan penuh tantangan, soal soalnya hots.” </p>
                                <div class="aboutarea__icon__3">
                                    <i class="icofont-quote-left"></i>
                                </div>
                            </div>
                            <div class="aboutarea__img__3">
                                <img src="https://sahabatcpns.com/wp-content/uploads/2022/09/Ellipse-140.png" width="70px" alt="about">
                                <div class="aboutarea__img__name">
                                    <h6>Harsanto Hidayanto</h6>
                                    <p>Content Creator</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 custom__review__grid" data-aos="fade-up">
                        <div class="aboutarea__content__wraper__3">
                            <div class="aboutarea__para__3">
                                <p>“Menurutku kak, NIPASN itu platfrorm yang paling cocok sama aku kak, yang budget paspasan untuk freshgraduate, yang harganya gak terlalu mahal tapi ilmunya yang didapat sangat mahal.” </p>
                                <div class="aboutarea__icon__3">
                                    <i class="icofont-quote-left"></i>
                                </div>
                            </div>
                            <div class="aboutarea__img__3">
                                <img src="https://sahabatcpns.com/wp-content/uploads/2022/09/Ellipse-141.png" width="70px" alt="about">
                                <div class="aboutarea__img__name">
                                    <h6>Cecep Sinaga</h6>
                                    <p>Mahasiswa</p>
                                </div>
            ...
            <div class="aboutarea__img__3">
                <img class="aboutarea__3__img__1" src="assets/landing_page/img/about/about_6.png" alt="about">
                <img class="aboutarea__3__img__2" src="assets/landing_page/img/about/about_7.png" alt="about">
                <img class="aboutarea__3__img__3" src="assets/landing_page/img/about/about_9.png" alt="about">
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3">
                            <div class="copyright__logo">
                                <a href="#"><img src="assets/landing_page/img/logo/logo_NIPASN.jpeg" width="80px" alt="logo"></a>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6">
                            <div class="footerarea__copyright__content footerarea__copyright__content__2">
                                <p>Copyright © <span></span> by NIPASN. All Rights Reserved.</p>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3">
                            <div class="footerarea__icon footerarea__icon__2">
                                <ul>
                                    <li><a href="https://www.tiktok.com/@nipasnbimbel?_t=8eMTjA8sbfl&_r=1" target="_blank" rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#ffffff}</style><path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"/></svg></a></li>
                                    <li><a href="https://t.me/Infoasn2023" target="_blank" rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" target="_blank" rel="noopener noreferrer" height="1em" viewBox="0 0 496 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#ffffff}</style><path d="M248,8C111.033,8,0,119.033,0,256S111.033,504,248,504,496,392.967,496,256,384.967,8,248,8ZM362.952,176.66c-3.732,39.215-19.881,134.378-28.1,178.3-3.476,18.584-10.322,24.816-16.948,25.425-14.4,1.326-25.338-9.517-39.287-18.661-21.827-14.308-34.158-23.215-55.346-37.177-24.485-16.135-8.612-25,5.342-39.5,3.652-3.793,67.107-61.51,68.335-66.746.153-.655.3-3.1-1.154-4.384s-3.59-.849-5.135-.5q-3.283.746-104.608,69.142-14.845,10.194-26.894,9.934c-8.855-.191-25.888-5.006-38.551-9.123-15.531-5.048-27.875-7.717-26.8-16.291q.84-6.7,18.45-13.7,108.446-47.248,144.628-62.3c68.872-28.647,83.183-33.623,92.511-33.789,2.052-.034,6.639.474,9.61,2.885a10.452,10.452,0,0,1,3.53,6.716A43.765,43.765,0,0,1,362.952,176.66Z"/></svg></a></li>
                                    <li><a href="https://www.instagram.com/bimbelnipasn.id/" target="_blank" rel="noopener noreferrer"><i class="icofont-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
